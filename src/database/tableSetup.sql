...
GRANT ALL PRIVILEGES ON TDDD36.* TO 'serverUser'@'localhost' WITH GRANT OPTION;
# Logga ut
exit;
...
CREATE TABLE IF NOT EXISTS contact(Id INT PRIMARY KEY AUTO_INCREMENT, Name VARCHAR(255), InetAddress VARCHAR(255), GCM_ID VARCHAR(255)) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS assignment(Id INT PRIMARY KEY AUTO_INCREMENT, Name VARCHAR(255), Latitude VARCHAR(255), Longitude VARCHAR(255), Region TEXT, Agents VARCHAR(255), Sender VARCHAR(255), ExternalMission VARCHAR(255), Description TEXT, Timespan VARCHAR(255), Status VARCHAR(255), Cameraimage MEDIUMBLOB, Streetname VARCHAR(255), Sitename VARCHAR(255), Timestamp VARCHAR(255), Global_ID VARCHAR(255)) ENGINE=InnoDB;
